...
Ràng buộc: giữ strict_types, dùng json_phan_hoi, tuân thủ quyền ADMIN/GV & lớp; cập nhật DB qua PDO prepare; asset offline trong public/vendor.
...
Ghi chú an toàn: không lộ mật khẩu seed, không thêm CDN, kiểm file upload ≤2MB/ảnh hợp lệ.
```

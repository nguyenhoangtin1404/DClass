...
<h5>Quan ly hoc sinh</h5><a href="/public/trang_chinh.php" class="btn btn-secondary btn-sm">← Chấm điểm</a></div>
<div class="row g-3 mt-1">
  ...
  <div class="col-md-7"><div class="card"><div class="card-body">
    <h6>Thêm học sinh</h6>
    <div class="row g-2"><div class="col-4"><input id="ma" class="form-control" placeholder="Mã (tùy chọn)"></div>
    <div class="col-8"><input id="ho_ten" class="form-control" placeholder="Họ tên"></div></div>
...
them.onclick=async()=>{
  ...
  const j=await r.json(); if(j.ok){ msg.textContent='Đã thêm'; ho_ten.value=''; ma.value=''; nap(); } else msg.textContent=j.thong_bao||'Lỗi';
};
nap();
</script></body></html>

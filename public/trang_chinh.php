...
<nav class="navbar navbar-light bg-light px-3"><span class="navbar-brand">Chấm điểm</span>
  <div class="ms-auto"><a class="btn btn-outline-secondary btn-sm" href="/public/hoc_sinh_quan_ly.php">Học sinh</a>
  ...
  <button class="btn btn-outline-danger btn-sm" id="dang_xuat">Đăng xuất</button></div></nav>
<div class="container py-3">
  <div class="row g-3">
    <div class="col-md-6"><div class="card"><div class="card-body">
      <h6>Tìm học sinh</h6><input id="tu_khoa" class="form-control" placeholder="Tên hoặc mã">
...
function hienThongTin(){ const el=thong_tin; el.textContent = hsHienTai ? `${hsHienTai.ho_ten} · Lop ${hsHienTai.ten_lop||''} · Diem: ${hsHienTai.so_du}` : 'Chua Chưa chọn học sinh'; }
